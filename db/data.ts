...
export interface Product {
  id: string;
  name: string;
  title?: string; // Para compatibilidad con ProductLayout
  brand?: string;
  image: string;
  images?: string[]; // Para galería de imágenes
  currentPrice: string;
  price?: string; // Para compatibilidad con ProductLayout
  originalPrice?: string;
  oldPrice?: string; // Para compatibilidad con ProductLayout
  discount?: string;
  installments?: number;
  monthlyAmount?: string;
  cuotas?: string; // Para compatibilidad con ProductLayout
  condition: "Nuevo" | "Como Nuevo" | "Outlet" | "Semi Nuevo";
  category: string;
  tags?: string[]; // Para compatibilidad con ProductLayout
  capacity?: string | string[]; // Puede ser string o array de strings
  color?: string | string[]; // Puede ser string o array de strings
  description?: string;
  features?: string[];
}
...
import { mainProducts, promotionProducts } from './products';
import { getProductDetailById } from './productDetails';
...
export const data = {
  ...
  // Datos de PaymentMethodsSection
  paymentMethods: [
    {
...
// Funciones utilitarias para obtener datos
...
// Función para obtener productos detallados
...
// Funciones para obtener datos de secciones
